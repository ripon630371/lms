...
<head>
    ...
    <title>LMS</title>
    <!--load progress bar-->
    <script src="../asstes/vendor/pace/pace.min.js"></script>
    <link href="../asstes/vendor/pace/pace-theme-minimal.css" rel="stylesheet" />
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        <div class="user-photo">
                            <img alt="profile photo" src="../asstes/images/avatar/avatar_user.jpg" />
                        </div>
                        <div class="user-info">
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="has-child-item close-item <?= $page == 'manage-books.php' ? 'open-item' : ''; ?><?= $page == 'add-book.php' ? 'open-item' : ''; ?>">
